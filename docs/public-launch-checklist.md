...
- [x] Windows desktop installer path does not require normal volunteers to install Node/npm manually; clean-machine QA still required.
...
- [x] Add public-safe shareable impact card foundation without auto-posting.
