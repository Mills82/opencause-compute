...
export const BADGE_DEFINITIONS: BadgeDefinition[] = [
  ...
  { slug: '100-candidate-evidence', name: '100 Candidate Evidence Records', description: 'Contributed to 100 consensus-passed candidate evidence records.', category: 'milestone', criteriaKind: 'consensusPassedContributions', criteriaValue: 100 },
  { slug: '1000-candidate-evidence', name: '1,000 Candidate Evidence Records', description: 'Contributed to 1,000 consensus-passed candidate evidence records.', category: 'milestone', criteriaKind: 'consensusPassedContributions', criteriaValue: 1000 },
