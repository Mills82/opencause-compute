...
function db(): DatabaseState {
  ...
  return {
    projects: [], workPackets: [], nodes: [], claims: [], results: [], ingestionRuns: [], auditEvents: [], volunteerEnrollments: [], volunteerProfileNodes: [], teamMemberships: [], badgeDefinitions: [], volunteerBadges: [], volunteerStatsSnapshots: [], teamStatsSnapshots: [], impactDigests: [], projectCorpusEstimates: [], publicReports: [],
