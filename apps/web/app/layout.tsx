          ...
          <header className="border-b border-line bg-panel/70">
            <div className="mx-auto flex max-w-6xl flex-col gap-4 px-6 py-5 md:flex-row md:items-center md:justify-between">
              <a className="flex items-center gap-3" href="/" aria-label="OpenCause Compute home">
                <img src="/opencause-compute-logo.svg" alt="OpenCause Compute" className="h-10 w-auto max-w-[240px]" />
              </a>
              <nav className="flex flex-wrap gap-3 text-sm text-slate-300" aria-label="Primary navigation">
