...
async function loadDbFromRelational(client?: PoolClient): Promise<DatabaseState> {
  ...
  try {
    ...
    return databaseSchema.parse({
      ...
      extractedClaims: extractedClaims.rows.map((row) => ({
        id: row.id,
        resultId: row.result_id,
        claimType: row.claim_type,
        evidenceOrigin: row.evidence_origin,
        evidenceType: row.evidence_type,
        studyContext: row.study_context,
        polarity: row.polarity,
        direction: row.direction,
        cancerType: row.cancer_type ?? undefined,
        biomarkerMention: row.biomarker_mention ?? undefined,
        biomarkerNormalizedGuess: row.biomarker_normalized_guess ?? undefined,
        drugOrInterventionMention: row.drug_or_intervention_mention ?? undefined,
        drugNormalizedGuess: row.drug_normalized_guess ?? undefined,
        variantMention: row.variant_mention ?? undefined,
        pathwayMention: row.pathway_mention ?? undefined,
        cellLineMention: row.cell_line_mention ?? undefined,
        speciesOrModelMention: row.species_or_model_mention ?? undefined,
        outcomeMention: row.outcome_mention ?? undefined,
        outcomeMeasureMention: row.outcome_measure_mention ?? undefined,
        statisticalEvidenceMention: row.statistical_evidence_mention ?? undefined,
        sampleSizeMention: row.sample_size_mention ?? undefined,
        ...
        sentenceIndex: row.sentence_index ?? undefined,
        ...
        reviewPriority: row.review_priority ?? undefined,
