...
function db(): DatabaseState {
  return {
    ...
    teamStatsSnapshots: [], impactDigests: [], workerControl: { paused: false, idleMode: 'user-and-cpu', minIdleSeconds: 120, maxCpuPercent: 35, runNowToken: 0, updatedAt: '2026-01-01T00:00:00.000Z' }
  };
}
